...
JURY = {
 ...
 'UE3': [
  ...
  (2022,'p. 9',"Sujet accessible (stratégie, GRH, enjeux contemporains) ; un volet marketing, notamment digital, « qu'il convient d'intégrer dans son programme de révision ».",'2.1|2.3|4.1',False,"Intégrer le marketing digital aux révisions."),
  (2022,'p. 9',"« l'épreuve constitue une étude de cas et pas des questions de cours » : contextualiser, ne pas paraphraser les annexes, être analytique et non descriptif.",'',True,"S'entraîner à la démarche d'étude de cas."),
  (2022,'p. 10',"« La partie marketing n'est pas maîtrisée et souvent abandonnée » ; lacunes sur la RSE et la politique RH ; « Les notions de stratégie ne sont pas maîtrisées ».",'2.3|1.2|4.2|2.1',True,"Marketing (y compris digital), RSE, politique RH et stratégie : fiches + application au cas."),
  (2022,'p. 10',"« Le calcul de la masse salariale n'était pas compliqué mais peu de candidat[s] ont réussi par manque de maîtrise ».",'4.1',True,"Masse salariale : faiblesse signalée en 2022 puis de nouveau en 2025."),
 ...
 'UE5': [
  ...
  (2022,'p. 11',"Cession d'une ESN : schéma directeur, workflow facture (typologies, circuits de validation), Factur-X, SaaS vs On Premise, tout-en-un, DPO mutualisé (RGPD) ; ne pas confondre « définir » et « modéliser ».",'1.1|1.3|3.1|2.1|5.2',False,"Respecter le verbe de consigne : définir, décrire, caractériser, analyser, modéliser, schématiser."),
  (2022,'p. 11',"« Ce sujet préfigure les sujets et études de cas qui vont suivre c'est-à-dire à la fois factuels, actuels et analytiques avec une forte dimension managériale » ; qualité rédactionnelle médiocre dans une partie des copies.",'',True,"Posture managériale et rédaction soignée."),
