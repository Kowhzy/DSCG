...
NEW = {
 ...
 ('UE3','2024','1'): ('2.1|2.3|2.5','','Porter_5F|tarification|previsions_resultat',"2.2 retiré : la grille de prix relève de 2.3 (tarification) et les prévisions de 2.5"),
 ('UE3','2024','2'): ('2.5|2.3|2.4','3.3','ecarts|facteur_rare|digital|franchise_plateforme',"2.2 retiré : facteur rare = technique de DCG mobilisée pour un choix de programme (2.5), pas une notion de 2.2"),
