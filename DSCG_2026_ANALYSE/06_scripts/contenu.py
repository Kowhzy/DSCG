...
SYNTHESE = {
 ...
 'UE3': [
  ...
  "Pilotage et performance globale (tableaux de bord, TBS, coûts cachés, RSE) : 7 sessions sur 10 en principal, 5 sur 6 depuis 2020.",
 ...
 'UE5': [
  ...
  "Droit et sécurité de l'information (RGPD/DPO, conservation, dématérialisation, cryptographie) : 7 sessions sur 10. Surveillance et prévention (PSSI, PCA/PRA, BYOD, Shadow IT, Zero Trust) figure dans chacune des 3 dernières sessions.",
...
SURPRISES = {
 ...
 'UE3': [
  "Rubriques jamais interrogées en principal sur 10 ans : 1.3 (contrôle de gestion et systèmes d'information) et 2.7 (contrôle de gestion et changement organisationnel). Le management du changement (3.1) n'est plus apparu depuis 2018, alors que les jurys 2020 et 2021 en font un « point majeur ».",
 ...
 'UE5': [
  "La partie 4 « performance informationnelle » (30 h sur 140 selon la source secondaire) est quasi absente depuis 2020 : contrats de services, budgets et évaluation des projets n'y ont jamais été interrogés en principal ; coûts seulement en 2021 (indicateurs de coût).",
...
TROUS = {
 ...
 'UE3': {
  ...
  '3.2': "Seulement 2018 D2 (progrès continu) et 2020 D2 (diagnostic des processus, coûts des dysfonctionnements).",
  '1.2': "Seulement 2021 D4 (rôle du contrôleur en start-up) et 2016 D2 Q7.",
 },
 'UE5': {
...
METHODE_COMMUNE = [
 ...
 ("Fréquences", "Une session compte 1 pour une rubrique si au moins un dossier la mobilise en principal (plusieurs dossiers de la même session ne comptent qu'une fois). Fréquence sur 10 sessions (2016-2025), sur le programme actuel (6 sessions 2020-2025), sur les 5 et les 3 dernières. UE2 2022 : deux sujets (annulation et nouvelle épreuve), chacun pondéré ½."),
 ...
 ("Limites", "Rapports du jury 2022 et 2023 non consultés (non présents dans le Drive ; sites officiels inaccessibles depuis l'environnement d'analyse). Annexe officielle du programme non relue directement : les intitulés de rubriques proviennent de ta page Notion qui l'a relevée, et les notions détaillées sont un résumé de travail. Sujets : copies FicheBEN des sujets officiels (filigrane) ou PDF texte du Drive. UE3 2024 et UE5 2024 : scans non exploitables (structure reprise du rapport du jury et d'une transcription). Les rattachements aux rubriques relèvent d'un jugement d'analyste ; ils sont tous traçables dans 02_data. Ton Mac n'était pas accessible : tes ressources ont été repérées via Notion et Google Drive."),
]
